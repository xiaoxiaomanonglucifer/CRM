...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                    ...
                    success: function (resp) {
                        if (resp.code == "1") {
                            ...
                            htmlStr += '\t<div id="div_"+' + resp.retData.id + ' class="remarkDiv" style="height: 60px;">\n' +
                                ...
                                '    \t\t\t\t<font color="gray">交易</font> <font color="gray">-</font> <b>${tran.name}</b> <small style="color: gray;"> ' + resp.retData.createTime + ' 由${sessionScope.sessionUser.name}创建</small>\n' +
                                '    \t\t\t\t<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">\n' +
                                '    \t\t\t\t\t<a class="myHref" href="javascript:void(0);" remarkId=' + resp.retData.id + '><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>\n' +
                                '    \t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;\n' +
                                '    \t\t\t\t\t<a class="myHref" href="javascript:void(0);" remarkId=' + resp.retData.id + '><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>\n' +
                                '    \t\t\t\t</div>\n' +
                                '    \t\t\t</div>\n' +
                                '    \t\t</div>';
            ...
            //修改备注
            $("#updateTranRemarkBtn").click(function () {
                var id = $("#edit-id").val();
                ...
                $.ajax({
                    url: 'workbench/transaction/updateTranRemarkByRemarkId',
                    data: {
                        id: id,
                        noteContent: noteContent
                    },
            ...
            $("#remarkDivList").on("click", "a[name='deleteA']", function () {
                var id = $(this).attr("remarkId");
                $.ajax({
                    url: 'workbench/transaction/deleteTranRemarkByRemarkId',
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                        id: id
    ...
    <div class="modal-dialog" role="document" style="width: 40%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="updateTranRemarkBtn">更新</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div style="position: relative; top: 100px; left: 40px;">
        ...
        <div style="position: relative;top: 0px;">
            <table id="activityTable" class="table table-hover" style="width: 900px;">
                ...
                <c:forEach items="${tranHistoryList}" var="tranHis">
                    <tr>
                        <td>${tranHis.stage}</td>
                        <td>${tranHis.money}</td>
                        <td>${tranHis.expectedDate}</td>
                        <td>${tranHis.createTime}</td>
                        <td>${tranHis.createBy}</td>
                    </tr>
                </c:forEach>
                <%--                <tr>--%>
                <%--                    <td>资质审查</td>--%>
